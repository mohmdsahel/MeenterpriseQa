    ...
    >
      <div className="relative flex w-full flex-1 items-center justify-center isolate z-0">
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-5xl md:text-h2 mb-2 text-center tracking-tight absolute z-30 top-[10%] sm:top-[15%] text-color-4"
        >
          Spotlight Speakers
        </motion.h1>
        ...
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic from-color-3 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
          {/* Updated background mask color to Dark background (using new color name) */}
          <div className="absolute w-[100%] left-0 bg-color-5/10 h-40 bottom-0 z-20 [mask-image:linear-gradient(to_top,white,transparent)]" />
        ...
        <motion.div
          ...
          // Updated conic gradient color to Vibrant Cyan (using new color name)
          className="absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic from-transparent via-transparent to-color-3 text-white [--conic-position:from_290deg_at_center_top]"
        >
          ...
          {/* Updated background mask color to Dark background (using new color name) */}
          <div className="absolute w-[100%] right-0 bg-color-5/10 h-40 bottom-0 z-20 [mask-image:linear-gradient(to_top,white,transparent)]" />
        </motion.div>
        ...
        <div className="absolute inset-auto z-40 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-color-3 opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-color-3/50 blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
          ...
          className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[7rem] bg-color-3"
        ></motion.div>
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-gradient-to-br from-color-5/90 to-color-5/70 backdrop-blur-sm rounded-lg sm:rounded-xl md:rounded-2xl border border-color-5/20 shadow-2xl overflow-hidden transform-gpu"
      ...
      >
        <div className="flex flex-col-reverse sm:flex-row items-center">
          <div className="w-full sm:w-2/3 p-3 sm:p-4 md:p-10">
            ...
            <h2 className="text-xl sm:text-2xl md:text-4xl font-bold mb-1 sm:mb-2 md:mb-4 text-color-4/80">
              {title}
            </h2>
            {/* Updated text color to Vibrant Magenta (using new color name) */}
            <p className="text-color-2/90 mb-2 sm:mb-4 md:mb-6 text-xs sm:text-sm md:text-lg leading-relaxed">
              {text}
            </p>
            <div className="flex items-center justify-between">
              {/* Updated organization text color to Vibrant Magenta (using new color name) */}
              <p className="text-color-2/80 text-xs sm:text-sm md:text-lg italic">
                {organization}
              </p>
              <a
                href={link}
                target="_blank"
                // Updated button background and border to Dark background (using new color name)
                className="group flex items-center gap-1 sm:gap-2 px-2 sm:px-3 md:px-4 py-1 sm:py-1.5 md:py-2 rounded-md sm:rounded-lg bg-color-2/20 hover:bg-color-3/20 transition-all duration-300 border border-color-2/20"
              >
                {/* Updated button text color to Vibrant Magenta (using new color name) */}
                <span className="text-color-2 text-[10px] sm:text-xs md:text-sm font-medium">Connect</span>
                <img
                  src={linkedin}
                  width={12}
                  height={12}
      ...
      <div className="min-h-[100svh] relative overflow-hidden flex flex-col" id="speakers">
        ...
        <div className="w-full relative z-[4] mt-12 sm:mt-12 mb-12 sm:mb-20">
          <motion.h1
            ...
            // Updated heading color to Off-white (using new color name)
            className="text-4xl sm:text-5xl md:h2 m-8 sm:m-12 text-center tracking-tight z-30 text-color-4"
          >
            Series Speakers
          </motion.h1>
          <SeriesCardDemo />
