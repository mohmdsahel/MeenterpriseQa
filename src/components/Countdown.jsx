...
const COUNTDOWN_TARGET = new Date("2025-10-22T23:59:59");
			...
			<div className="flex justify-center gap-[clamp(0.25rem,1vw,2rem)] flex-nowrap">
				{Object.entries(timeLeft).map(([label, value]) => (
					...
					>
						...
						<div className="text-[clamp(1.5rem,4vw,3rem)] font-bold text-color-2 font-sans [text-shadow:0_0_10px_rgba(232,197,145,0.5)] m-1">
